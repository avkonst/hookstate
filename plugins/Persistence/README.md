...
Plugin for @hookstate/core to enable persistence of managed data states to browser's local storage. See [demo](https://hookstate.netlify.com/plugin-persistence).
